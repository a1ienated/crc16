 ...
 */
    void calculateCRC16(const QByteArray src = 0, const quint16 crc16Prev = 0xFFFF);
 ...
 */
    CRC16Modbus(const QByteArray src = 0, const quint16 crc16Prev = 0xFFFF);
