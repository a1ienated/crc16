...
CRC16Modbus::CRC16Modbus(const QByteArray src, const quint16 crc16Prev):
    crcTable{0}
{
...
void CRC16Modbus::calculateCRC16(const QByteArray src, const quint16 crc16Prev)
{
    // Для примера:
    // 000BDF2F2F
    // length = 10
    ...
    quint16 crc16Modbus = crc16Prev; // pay attention to initialization
